...
mvn install:install-file -Dfile=JTangoCommons-1.0.0.jar -DgroupId=org.tango -DartifactId=JTangoCommons -Dversion=1.0.0 -Dpackaging=jar -DpomFile=JTangoCommons-1.0.0.pom
