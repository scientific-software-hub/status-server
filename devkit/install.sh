...
mvn install:install-file -Dfile=JTangoServer-1.0.2-alpha-all.jar -DgroupId=org.tango -DartifactId=JTangoServer -Dversion=1.0.2-alpha-all -Dpackaging=jar -DgeneratePom=true -Dpackaging=jar
